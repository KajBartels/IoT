...
def notification_handler(sender, data):
    # Convert byte data into three float values (12 bytes total)
...
#
        ...
        # Start notification
        # Dit zorgt ervoor dat de Arduino steeds x/y/z-waardes stuurt, en je Python-code die opvangt en print
