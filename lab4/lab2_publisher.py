...
def notification_handler_factory(socket):
    def notification_handler(sender, data):
        x, y, z, a, b, c = struct.unpack("ffffff", data)
        # Round to 2 decimal places
        arr = numpy.array([round(x, 2), round(y, 2), round(z, 2), round(a, 2), round(b, 2), round(c, 2)], dtype=numpy.float32)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", default="tcp://127.0.0.1:5558", help="ZeroMQ URL to bind to")
